...
- **Artifacts:** Jupyter notebooks (`.ipynb`), no separate Python package. Some notebooks assume Google Colab and Google Drive paths; support both local and Colab when changing paths or adding features.
